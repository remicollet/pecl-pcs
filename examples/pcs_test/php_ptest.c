...
static PHP_MINIT_FUNCTION(ptest)
{
	...
	if (PTEST_G(load_empty)) {
		...
		switch(PTEST_G(test_case)) {
			/* Register data */
			case 1:
				id = register_data1("ext/ptest/data1.php", 0 TSRMLS_CC);
				break;
			case 2:
				id = register_data1("ext/ptest/data1.txt", 0 TSRMLS_CC);
				break;
			case 3:
				id = register_data1("ext/ptest/data1.php", PCS_AUTOLOAD_DISABLE TSRMLS_CC);
				break;
			case 4:
				id = register_data1("ext/ptest/data1.txt", PCS_AUTOLOAD_FORCE TSRMLS_CC);
				break;
			case 5:
				id = register_data1("ext/ptest/../data1.php", 0 TSRMLS_CC);
				break;
